# Containerized Flask End Point on Heroku App

Flask app in Docker container that can be run locally or on Heroku.

Boilerplate code includes:
* Flask Talisman forcing https communication
* Accomodates Dev, Test and Prod servers
* Tests for local, Test and Prod
* Automatic testing and deployment with travis
